...
export class BuildingTool extends Tool {
    ...
    onMouseDown(x, y, event) {
        if (event.button === 0) {
            ...
            // SALVATAGGIO STORIA: Salviamo lo stato attuale prima della modifica
    ...
    drawPreview(ctx) {
        // 1. Disegna l'anteprima dell'edificio (poligono)
        ...
        // 2. Disegna gli assi locali per feedback sulla scala
        this.editor.renderer.drawLocalAxes(
            this.position,
            this.rotation,
            this.scaleX,
            this.scaleY,
            this.scaleConstraint // Passa 'x', 'y' o null
        );
    }
