(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.NavMeshGenerator = factory());
                    ...
                    for (var vertexIndex = 0; vertexIndex < contour.length; vertexIndex++) {
                        ...
                        if (vertex.region !== RasterizationCell.OBSTACLE_REGION_ID &&
                            ...
                            if (commonVertexContours.length < 3) {
                                console.error("The vertex is shared by only ".concat(commonVertexContours.length, " regions."));
                            }
...
//# sourceMappingURL=NavMeshGenerator.js.map
